...
public class JSWaiter extends TestSetUp
{
   ...
   private void ajaxComplete() {
    ...
    private void waitForJQueryLoad() {
        try {
            ExpectedCondition<Boolean> jQueryLoad = driver -> ((Long) ((JavascriptExecutor) TestSetUp.driver)
    ...
    private void waitUntilJSReady() {
        try {
            ExpectedCondition<Boolean> jsLoad = driver -> ((JavascriptExecutor) TestSetUp.driver)
    ...
    public void waitForElementAreComplete(By by, int expected) {
        ExpectedCondition<Boolean> angularLoad = driver -> {
            int loadingElements = TestSetUp.driver.findElements(by).size();
    ...
    public void waitForAnimationToComplete(String css) {
        ExpectedCondition<Boolean> angularLoad = driver -> {
            int loadingElements = TestSetUp.driver.findElements(By.cssSelector(css)).size();
